        ...
        <h1 class="text-center">
          <a href="/">
            <svg
              ...
              style="enable-background: new 0 0 698.696 698.696"
              xml:space="preserve"
